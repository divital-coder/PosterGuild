...
if __name__ == '__main__':
    ...
    # Extract the filename without extension as the poster name
    from pathlib import Path
    poster_name = Path(args.poster_path).stem.replace(' ', '_')
    ...
    from pathlib import Path
    poster_basename = Path(args.poster_path).stem  # Gets filename without extension
    output_dir = f'<{args.model_name_t}_{args.model_name_v}>_generated_posters/dataset/{poster_basename}'
